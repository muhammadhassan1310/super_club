<div class="pg-header">
	<h4 class="install_title"><span style="height:30px"><img  src="../webroot/img/Thumbnail-img2.png" height="80%" /></span> <?php echo __("Super Club - GYM Management Installation Wizard");?></h4>
</div>
