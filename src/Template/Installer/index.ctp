<div class="pg-header">
	<h4 class="install_title"><span style="height:30px"><img  src="<?php echo $this->request->webroot;?>img/Thumbnail-img2.png" height="80%" /></span> <?php echo __("Super Club - GYM Management Installation Wizard");?></h4>
</div>
    ...
    <div>
        ...
        <section>
		  ...
		  <div class="form-group">
			  ...
			  <div class="col-md-8">
			  <div class="input text">
			  <input type="text" name="name" class="form-control required" value="Super Club - Make Your Health">
			  </div>
			  </div>
		  </div>
		  <div class="form-group">
